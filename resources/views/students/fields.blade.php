...
<!-- Citizanship Field -->
<div class="form-group col-sm-6">
    {!! Form::label('Citizanship', 'Citizanship:') !!}
    {!! Form::text('Citizanship', null, ['class' => 'form-control','maxlength' => 60,'maxlength' => 60]) !!}
</div>

<!-- Religion Field -->
<div class="form-group col-sm-6">
    {!! Form::label('Religion', 'Religion:') !!}
    {!! Form::text('Religion', null, ['class' => 'form-control','maxlength' => 60,'maxlength' => 60]) !!}
</div>